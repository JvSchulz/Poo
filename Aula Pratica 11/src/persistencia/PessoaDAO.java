...
public class PessoaDAO {
	...
	public static void main(String[] args) {
		try {
			...
			List<Pessoa> filmes = new LinkedList<Pessoa>();
			for(Pessoa filme:sistema.selectAll()) {
	...
	public int selectNewId() throws SelectException {
		try {
			...
			throw new SelectException("Erro ao buscar nvo ida da tabela pessoa");
		}
		return 0;
	}
	...
	public void insert(Pessoa pessoa) throws InsertException, SelectException {
		try {
			...
			insert.setLong(3, pessoa.getCpf());
	...
	public void update(Pessoa pessoa) throws UpdateException {
		try {
			...
			update.setLong(2, pessoa.getCpf());
